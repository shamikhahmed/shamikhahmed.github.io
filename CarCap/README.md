...
**Version:** 0.1.1 · **SW cache:** `carcap-v2` · Capricorn Systems (Cap family)
...
All data stays in the browser. No accounts, no cloud sync in v0.1.1. Docs are text/meta + expiry only — no photo wallet yet.
